...
Later Milestone C checkpoints will add catalog reconciliation, native scheduling, the AutoBump policy decision, deterministic dual execution, normalization, guide validation, and immutable validation report history. No real schedule validation should be run until all of Milestone C is complete and reviewed.
